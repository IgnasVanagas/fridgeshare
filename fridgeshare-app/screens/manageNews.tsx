    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setEditingPost(null);
                fetchPosts();
                Alert.alert('Sėkmė', editingPost ? 'Naujiena atnaujinta' : 'Naujiena sukurta');
            } else {
            ...
            {posts.map((post) => (
                <View key={post.id} style={styles.postCard}>
                    ...
                    <View style={styles.postActions}>
                        ...
                        >
                            <Text style={styles.actionButtonText}>Redaguoti</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={[styles.actionButton, styles.deleteButton]}
                            onPress={() => handleDelete(post.id)}
                        >
                            <Text style={styles.actionButtonText}>Ištrinti</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            ))}
